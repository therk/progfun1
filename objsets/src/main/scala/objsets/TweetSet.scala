...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    if (left.isInstanceOf[Empty] && right.isInstanceOf[Empty]) {
      ...
      if (elem.retweets < tweet.retweets) tweet
      else elem
    } else {
...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = allTweets.filter(tw => google.exists(e => tw.text.contains(e)))
  lazy val appleTweets: TweetSet = allTweets.filter(tw => apple.exists(e => tw.text.contains(e)))
